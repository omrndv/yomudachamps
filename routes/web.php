...
Route::middleware('admin.auth')->group(function () {
    ...
    Route::middleware('permission:dashboard')->group(function () {
        Route::get('/admin/dashboard', [AdminController::class, 'dashboardHome'])->name('admin.dashboard.home');
    });
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::middleware('permission:seasons')->group(function () {
            ...
            Route::post('/dashboard/{season_id}/bracket/toggle-bye-visibility', [\App\Http\Controllers\BracketController::class, 'toggleByeVisibility'])->name('admin.season.bracket.toggle-bye-visibility');
