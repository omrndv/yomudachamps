        ...
        <div class="col-md-6">
            <div class="card card-custom border-0 p-4 bg-white shadow-sm rounded-4 h-100 d-flex flex-column justify-content-between">
                ...
                <p class="small text-muted mb-0 mt-2 text-center" style="font-size: 0.7rem;">
                    Total Rekap Akhir = Registrasi + Pemasukan Lain - Pengeluaran.
                </p>
            </div>
        </div>
    </div>

    {{-- Card: Kelola Catatan Keuangan --}}
    <div class="card border-0 shadow-sm p-4 rounded-4 bg-white mb-4">
        <div class="d-flex justify-content-between align-items-center mb-4 pb-2 border-bottom">
            <div>
                <h5 class="fw-bold text-dark mb-1">
                    <i class="bi bi-bank text-warning me-2"></i> Rekap Keuangan Season (Pemasukan & Pengeluaran)
                </h5>
                <p class="text-secondary small mb-0">Catat dan pantau pengeluaran turnamen (seperti hadiah, operasional) dan pemasukan tambahan (seperti sponsor, kas).</p>
            </div>
            ...
            <table class="table table-hover align-middle mb-0" style="font-size: 0.85rem;">
                <thead class="bg-light">
                    <tr class="text-secondary small fw-bold" style="font-size: 0.75rem;">
                        ...
                        <th class="py-2.5 border-0 text-center" width="100">Aksi</th>
                    </tr>
                </thead>
                <tbody>
