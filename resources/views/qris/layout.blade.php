...
<body class="flex min-h-screen text-gray-800">
    ...
    <aside class="w-64 bg-gray-900 text-white flex flex-col hidden md:flex">
        ...
        <div class="p-4 border-t border-gray-800">
            <a href="{{ route('qris.logout') }}" class="flex items-center px-4 py-2 text-red-400 hover:bg-red-500/10 rounded-lg transition-colors">
    ...
    <div class="flex-1 flex flex-col min-h-screen">
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-gray-800 text-white">
            <nav class="px-4 pt-2 pb-4 space-y-1">
                ...
                <a href="{{ route('qris.logout') }}" class="block px-3 py-2 rounded-md text-red-400">Logout</a>
            </nav>
        </div>
