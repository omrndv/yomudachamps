...
<div class="container py-5">
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card bg-dark border-secondary p-4 p-md-5" style="border-radius: 25px;">
                <h2 class="text-warning fw-bold mb-4">Ketentuan Layanan</h2>
                <div class="text-white-50" style="line-height: 1.8;">
                    <h5 class="text-white">1. Umum</h5>
