...
class QrisService
{
    ...
    public static function generateDynamicQris(string $staticQris, int $amount): string
    {
        ...
        // 3. Set Convenience Fee Indicator di tag 55 menjadi '01' (Artinya: Prompted to enter tip / No fee)
        // Beberapa issuer bank (termasuk BNI) menolak QRIS Dinamis jika tip indicator tidak didefinisikan saat tag 54 diset.
        $tags['55'] = '01';
